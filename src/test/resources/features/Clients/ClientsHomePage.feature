Feature: Client Home Page
  ...
  Scenario: In the kebab menu lots feature is working correctly as per the customers requirements. 
    When Click on kebab menu icon
    And Click on lots in the kebab menu popup
  ...
  Scenario: In the kebab menu cameras feature is working correctly as per the customers requirements. 
    When Click on kebab menu icon
    And Click on cameras in the kebab menu popup
  ...
  Scenario: In the kebab menu users feature is working correctly as per the customers requirements. 
    When Click on kebab menu icon
    And Click on users in the kebab menu popup
  ...
  Scenario: In the kebab menu violations feature is working correctly as per the customers requirements. 
    When Click on kebab menu icon
    And Click on violations in the kebab menu popup
